...
export class ConjuntoFacturacionController {
  ...
  async find(
    ...
    return this.conjuntoRepository.facturaciones(id).find(filter);
  }
  ...
  async create(
    ...
    return this.conjuntoRepository.facturaciones(id).create(facturacion);
  }
  ...
  async patch(
    ...
    return this.conjuntoRepository.facturaciones(id).patch(facturacion, where);
  }
  ...
  async delete(
    ...
    return this.conjuntoRepository.facturaciones(id).delete(where);
  }
}
